(function() {
  ...
  function initGeoLocation() {
	/*check if the window() gets the geolocation */
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        onPositionUpdated,
        onLoadPositionFailed, {
	/* if retrieved a minute ago then we do not do it again */
          maximumAge: 60000
        });
...
/* call back function: if we get the geolocation */
  ...
  function addItem(itemList, item) {
    ...
    if (item.image_url) {
      ...
      li.appendChild($create('img', {
        src: 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fgetbento.imgix.net%2Faccounts%2F827ee422cf171aa8c5ce37dfb41ba7cd%2Fmedia%2Fimages%2F1299emp-logo.png&imgrefurl=https%3A%2F%2Fwww.elevenmadisonpark.com%2F&tbnid=qHIA-GFHjsRGCM&vet=12ahUKEwid6PDC-czqAhWQZ98KHZTmA80QMygOegUIARDDAQ..i&docid=QHyqBl8rRq_y_M&w=1960&h=552&q=emp%20nyc&ved=2ahUKEwid6PDC-czqAhWQZ98KHZTmA80QMygOegUIARDDAQ'
      }));
    }
    // section
